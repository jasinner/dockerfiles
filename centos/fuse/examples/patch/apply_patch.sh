...
firewall-cmd --zone drop --change-interface em1

ssh2karaf "fabric:create --zookeeper-password ZOOPASS --wait-for-provisioning"
ssh2karaf "fabric:container-remove-profile root jboss-fuse-full --wait-for-provisioning"
...
#why?
#ssh2karaf "fabric:profile-edit --features jasypt-encryption --features fabric-zookeeper-commands fabric"

ssh2karaf "fabric:container-create-child root child1"
ssh2karaf "wait-for-provisioning"

ssh2karaf "fabric:version-create --parent 1.0 1.1"
ssh2karaf "fabric:patch-apply --version 1.1 file:///opt/rh/jboss-fuse-6.1.0.redhat-379-r2-611423.zip"
ssh2karaf "wait-for-provisioning"
ssh2karaf "fabric:version-create --parent 1.1 1.2"
ssh2karaf "fabric:patch-apply --version 1.2 file:///opt/rh/jboss-fuse-6.1.0.redhat-379-r2p1-611424.zip"
ssh2karaf "wait-for-provisioning"
ssh2karaf "fabric:container-upgrade 1.2 child1"
